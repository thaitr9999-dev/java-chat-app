...
/**
 * DTO (Data Transfer Object) dùng để nhận/gửi dữ liệu tin nhắn qua WebSocket.
 *
 * Tại sao cần constructor rỗng?
 * Jackson tạo object rỗng trước → rồi mới set từng field vào.
 * Không có constructor rỗng → Jackson thất bại khi deserialize JSON.
 * Công thức: POJO nhận JSON = constructor rỗng + đủ getter/setter.
 */
